...
const texto = tieneTexto
  ...
  : "Analiza el archivo adjunto.";
    ...
    const instrucciones = [
      ...
      "Analiza cada contenido por separado, incluso cuando provenga de Latinus, TV Azteca, Televisa, López-Dóriga, Ciro Gómez Leyva, Adela Micha, Canal Once o cualquier otro medio o comunicador.",
      "No uses listas negras ni listas blancas permanentes.",
      "Un medio público, privado, gubernamental, comercial o independiente no recibe credibilidad automática.",
      "Considera propiedad, financiamiento, relaciones con gobiernos o empresas, conflictos de interés, línea editorial, separación entre noticia y opinión, transparencia, fuentes, correcciones, historial documentado de verificaciones, titulares sensacionalistas, edición engañosa y omisión de contexto.",
      "Solo menciona antecedentes negativos cuando estén respaldados por fuentes verificables y concretas.",
      "Incluye correcciones, aclaraciones o respuestas del medio cuando existan.",
      "",
      "REPUTACIÓN EN REDES:",
    ...
    const contenidoUsuario = [
  {
    ...
    const openAIResponse = await fetch("https://api.openai.com/v1/responses", {
      ...
      body: JSON.stringify({
        ...
        max_output_tokens: modo === "profundo" ? 5000 : 3000
      })
    });
